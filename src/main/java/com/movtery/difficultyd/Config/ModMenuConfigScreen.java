...
public class ModMenuConfigScreen implements ModMenuApi {
    public static ConfigBuilder getConfigScreen() {
        ConfigBuilder modMenuConfigScreen = ConfigBuilder.create()
                .setTitle(Text.translatable("title.difficultyd.config"))
                .setTransparentBackground(true)
                .alwaysShowTabs()
                .setSavingRunnable(() -> getConfigScreen().build());

        ConfigCategory main = modMenuConfigScreen.getOrCreateCategory(Text.translatable("category.difficultyd.main"));
        ConfigCategory drop = modMenuConfigScreen.getOrCreateCategory(Text.translatable("category.difficultyd.drop"));
        ConfigCategory slowMining = modMenuConfigScreen.getOrCreateCategory(Text.translatable("category.difficultyd.slowmining"));
        ConfigCategory breakHunger = modMenuConfigScreen.getOrCreateCategory(Text.translatable("category.difficultyd.breakhunger"));

        ConfigEntryBuilder entryBuilder = modMenuConfigScreen.entryBuilder();
