...
public class ConfigScreen {
    public static ConfigBuilder getConfigScreen() {
        ConfigBuilder configScreen = ConfigBuilder.create()
                .setTitle(Text.translatable("title.difficultyd.config"))
                .setTransparentBackground(true)
                .alwaysShowTabs()
                .setSavingRunnable(() -> getConfigScreen().build());

        ConfigCategory main = configScreen.getOrCreateCategory(Text.translatable("category.difficultyd.main"));
        ConfigCategory drop = configScreen.getOrCreateCategory(Text.translatable("category.difficultyd.drop"));
        ConfigCategory slowMining = configScreen.getOrCreateCategory(Text.translatable("category.difficultyd.slowmining"));
        ConfigCategory breakHunger = configScreen.getOrCreateCategory(Text.translatable("category.difficultyd.breakhunger"));

        ConfigEntryBuilder entryBuilder = configScreen.entryBuilder();
